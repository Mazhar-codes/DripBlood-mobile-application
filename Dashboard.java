...
import com.example.dripblood.fragments.AboutUs;
import com.example.dripblood.fragments.AchievmentsView;
import com.example.dripblood.fragments.BloodInfo;
import com.example.dripblood.fragments.HomeView;
import com.example.dripblood.fragments.MyRequests;
import com.example.dripblood.viewmodels.UserData;
...
public class Dashboard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            startActivity(new Intent(getApplicationContext(), EmergencyContactsActivity.class));
            ...
            Intent intent = new Intent(getApplicationContext(), BloodDonationChatActivity.class);
            startActivity(intent);
        }
